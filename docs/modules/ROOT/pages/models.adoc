...
// Generated from diagrams/ai-service-orchestration.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::ai-service-orchestration.svg[AI service orchestration]
