...
// Generated from diagrams/rag-ingestion-flow.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::rag-ingestion-flow.svg[RAG ingestion flow,align="center"]
