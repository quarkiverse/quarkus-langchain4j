...
|Unset
|If not set, no special handling is applied. See the xref:agent-and-tools.adoc[Function Calling] for details.
...
More details on function calling and tool integration can be found in the xref:agent-and-tools.adoc[Function Calling guide].
...
* xref:agent-and-tools.adoc[Function Calling and Tool Integration]
* xref:guide-ai-services-patterns.adoc[AI Services Patterns and Best Practices]
