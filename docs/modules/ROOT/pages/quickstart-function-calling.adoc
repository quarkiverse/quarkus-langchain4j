...
For more details, refer to the xref:agent-and-tools.adoc[Agent and Tools reference documentation].
...
[.lead]
* xref:agent-and-tools.adoc[Reference documentation covering function calling] — See more details about tools and function calling.
[.lead]
