...
* When using providers like Gemini or Azure OpenAI, also consider using short-lived access tokens obtained during login instead of long-lived API keys. See xref:models.adoc#_large_language_models_llms[Large Language Models (LLMs)].
