...
IMPORTANT: The Quarkus-specific auditing features have been deprecated. They will be replaced by the . Once complete, you will be able to observe the https://docs.langchain4j.dev/tutorials/observability#types-of-events[LangChain4j observability events] as CDI events.
