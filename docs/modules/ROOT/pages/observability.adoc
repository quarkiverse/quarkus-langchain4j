...
IMPORTANT: The Quarkus-specific auditing features have been deprecated. They will be replaced by the https://docs.langchain4j.dev/tutorials/observability#ai-service-observability[LangChain4j AI Service Observability]. Once complete, you will be able to observe the https://docs.langchain4j.dev/tutorials/observability#types-of-events[LangChain4j observability events] as CDI events.
