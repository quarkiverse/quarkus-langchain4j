...
Provided support for JDK 21 and JDK 25.
JDK version leads to different TornadoVM SDK.
Install both with SDKMAN!:

.Available TornadoVM backends
NOTE: opencl, ptx, spirv, full
...
# TornadoVM SDK
sdk install tornadovm 3.0.0-<backend>
sdk use tornadovm 3.0.0-<backend>
----
* JDK 25:
[source,shell]
----
...
# TornadoVM SDK
sdk install tornadovm 3.0.0-jdk25-<backend>
sdk use tornadovm 3.0.0-jdk25-<backend>
----
...
:provider-artifact: quarkus-langchain4j-gpu-llama3
