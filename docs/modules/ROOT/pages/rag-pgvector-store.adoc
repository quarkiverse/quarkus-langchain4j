...
The https://docs.quarkiverse.io/quarkus-langchain4j/dev/rag-hibernate-store.html[Hibernate extension] is an alternative
to this which support additional features and customizations and will supersede this extension in the future.
...
:provider-artifact: quarkus-langchain4j-pgvector
