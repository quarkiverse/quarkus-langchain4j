...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-milvus_quarkus-langchain4j-milvus-store-name-host_bt]] [.property-path]##link:#quarkus-langchain4j-milvus_quarkus-langchain4j-milvus-store-name-host_bt[`+++quarkus.langchain4j.milvus."store-name".host+++`]##
ifdef::add-copy-button-to-config-props[]
