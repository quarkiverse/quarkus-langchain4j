...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-chroma_quarkus-langchain4j-chroma-store-name-collection-name_bt]] [.property-path]##link:#quarkus-langchain4j-chroma_quarkus-langchain4j-chroma-store-name-collection-name_bt[`+++quarkus.langchain4j.chroma."store-name".collection-name+++`]##
ifdef::add-copy-button-to-config-props[]
