...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-weaviate_quarkus-langchain4j-weaviate-store-name-object-class_bt]] [.property-path]##link:#quarkus-langchain4j-weaviate_quarkus-langchain4j-weaviate-store-name-object-class_bt[`+++quarkus.langchain4j.weaviate."store-name".object-class+++`]##
ifdef::add-copy-button-to-config-props[]
