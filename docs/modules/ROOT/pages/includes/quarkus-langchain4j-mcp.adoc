...
a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-extra-params-param-name]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-extra-params-param-name[`+++quarkus.langchain4j.mcp."client-name".extra-params."param-name"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".extra-params."param-name"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Extra parameters that can be used by extensions to configure additional behavior for this MCP client. For example, `extra-params.oidc-client-name` can be used by the `langchain4j-oidc-client-mcp-auth-provider` extension to select a named OIDC client for acquiring access tokens.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__EXTRA_PARAMS__PARAM_NAME_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__EXTRA_PARAMS__PARAM_NAME_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
