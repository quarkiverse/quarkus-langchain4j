...
[.description]
--
Proxy configuration name. There are some rules for using Quarkus Proxy Registry configuration:

 - If `quarkus.langchain4j.openai.proxy-host` is set then this configuration will be ignored.
