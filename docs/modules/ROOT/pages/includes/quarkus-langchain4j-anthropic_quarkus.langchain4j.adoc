...
Not supported by `claude-opus-4-7`, `claude-opus-4-8`, `claude-sonnet-5`, `claude-fable-5`, and later models. See link:https://platform.claude.com/docs/en/about-claude/models/migration-guide[Anthropic's migration guide].
