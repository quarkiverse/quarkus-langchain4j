...
[.description]
--
List of directories from which skills should be loaded. Each entry can be a relative path (resolved against the current working directory) or a classpath resource path.
