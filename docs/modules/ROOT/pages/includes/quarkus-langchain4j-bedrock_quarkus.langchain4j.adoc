...
a| [[quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-chat-model-prompt-caching-ttl]] [.property-path]##link:#quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-chat-model-prompt-caching-ttl[`+++quarkus.langchain4j.bedrock.chat-model.prompt-caching-ttl+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.bedrock.chat-model.prompt-caching-ttl+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
How long the prompt cache entries live. Only applies when `prompt-caching` is set.

*Allowable values:* `++[++5m, 1h++]++` (the SDK constant names `VALUE_5_M` and `VALUE_1_H` are accepted as well)


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BEDROCK_CHAT_MODEL_PROMPT_CACHING_TTL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BEDROCK_CHAT_MODEL_PROMPT_CACHING_TTL+++`
endif::add-copy-button-to-env-var[]
--
a|`VALUE_5_M`, `VALUE_1_H`, `UNKNOWN_TO_SDK_VERSION`
|`+++5m+++`
...
This uses the legacy budget-based reasoning configuration (`reasoning_config.type=enabled` with `budget_tokens`), which is not accepted by newer models such as Claude Opus 4.7{plus}. For those models use `reasoning-effort` instead.
...
a| [[quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-chat-model-reasoning-effort]] [.property-path]##link:#quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-chat-model-reasoning-effort[`+++quarkus.langchain4j.bedrock.chat-model.reasoning-effort+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.bedrock.chat-model.reasoning-effort+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Enables adaptive reasoning with the given effort level (`reasoning_config.type=adaptive` with `output_config.effort`). This is the only reasoning configuration accepted by newer models such as Claude Opus 4.7{plus}, which reject the legacy budget-based `reasoning` configuration. When set, it takes precedence over the `reasoning` token budget.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BEDROCK_CHAT_MODEL_REASONING_EFFORT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BEDROCK_CHAT_MODEL_REASONING_EFFORT+++`
endif::add-copy-button-to-env-var[]
--
a|`low`, `medium`, `high`
|
...
a| [[quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-model-name-chat-model-prompt-caching-ttl]] [.property-path]##link:#quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-model-name-chat-model-prompt-caching-ttl[`+++quarkus.langchain4j.bedrock."model-name".chat-model.prompt-caching-ttl+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.bedrock."model-name".chat-model.prompt-caching-ttl+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BEDROCK__MODEL_NAME__CHAT_MODEL_PROMPT_CACHING_TTL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BEDROCK__MODEL_NAME__CHAT_MODEL_PROMPT_CACHING_TTL+++`
endif::add-copy-button-to-env-var[]
--
a|`VALUE_5_M`, `VALUE_1_H`, `UNKNOWN_TO_SDK_VERSION`
|`+++5m+++`
...
a| [[quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-model-name-chat-model-reasoning-effort]] [.property-path]##link:#quarkus-langchain4j-bedrock_quarkus-langchain4j-bedrock-model-name-chat-model-reasoning-effort[`+++quarkus.langchain4j.bedrock."model-name".chat-model.reasoning-effort+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.bedrock."model-name".chat-model.reasoning-effort+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BEDROCK__MODEL_NAME__CHAT_MODEL_REASONING_EFFORT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BEDROCK__MODEL_NAME__CHAT_MODEL_REASONING_EFFORT+++`
endif::add-copy-button-to-env-var[]
--
a|`low`, `medium`, `high`
|
