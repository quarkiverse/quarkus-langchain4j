...
a| [[quarkus-langchain4j-bam_quarkus-langchain4j-bam-moderation-model-implicit-hate]]`link:#quarkus-langchain4j-bam_quarkus-langchain4j-bam-moderation-model-implicit-hate[quarkus.langchain4j.bam.moderation-model.implicit-hate]`


[.description]
--
The implicit hate detector is intended to identify subtle forms of hate speech. The float is a value from 0.1 to 1 that allows you to control when a content must be flagged by the detector.

ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BAM_MODERATION_MODEL_IMPLICIT_HATE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BAM_MODERATION_MODEL_IMPLICIT_HATE+++`
endif::add-copy-button-to-env-var[]
--|float 
|
...
[.description]
--
The HAP detector is intended to identify hateful, abusive, and/or profane language. The float is a value from 0.1 to 1 that allows you to control when a content must be flagged by the detector.
...
a| [[quarkus-langchain4j-bam_quarkus-langchain4j-bam-moderation-model-stigma]]`link:#quarkus-langchain4j-bam_quarkus-langchain4j-bam-moderation-model-stigma[quarkus.langchain4j.bam.moderation-model.stigma]`


[.description]
--
The stigma detector is intended to identify discrimination that is based on social attributes or characteristics. The float is a value from 0.1 to 1 that allows you to control when a content must be flagged by the detector.

ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BAM_MODERATION_MODEL_STIGMA+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BAM_MODERATION_MODEL_STIGMA+++`
endif::add-copy-button-to-env-var[]
--|float 
|
...
a| [[quarkus-langchain4j-bam_quarkus-langchain4j-bam-model-name-moderation-model-implicit-hate]]`link:#quarkus-langchain4j-bam_quarkus-langchain4j-bam-model-name-moderation-model-implicit-hate[quarkus.langchain4j.bam."model-name".moderation-model.implicit-hate]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BAM__MODEL_NAME__MODERATION_MODEL_IMPLICIT_HATE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BAM__MODEL_NAME__MODERATION_MODEL_IMPLICIT_HATE+++`
endif::add-copy-button-to-env-var[]
--|float 
|
...
a| [[quarkus-langchain4j-bam_quarkus-langchain4j-bam-model-name-moderation-model-stigma]]`link:#quarkus-langchain4j-bam_quarkus-langchain4j-bam-model-name-moderation-model-stigma[quarkus.langchain4j.bam."model-name".moderation-model.stigma]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_BAM__MODEL_NAME__MODERATION_MODEL_STIGMA+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_BAM__MODEL_NAME__MODERATION_MODEL_STIGMA+++`
endif::add-copy-button-to-env-var[]
--|float 
|
