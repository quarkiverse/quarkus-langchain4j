...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-oidc-client-name]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-oidc-client-name[`+++quarkus.langchain4j.mcp."client-name".oidc-client-name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".oidc-client-name+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The name of an OIDC client configured via `quarkus.oidc-client.<name>.++*++` used by the `langchain4j-oidc-client-mcp-auth-provider` extension to acquire access tokens (e.g. via the `client_credentials` grant) for this MCP client. Has no effect when that extension is not on the classpath.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__OIDC_CLIENT_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__OIDC_CLIENT_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a| [[quarkus-langchain4j-anthropic_quarkus-langchain4j-anthropic-chat-model-thinking-display]] [.property-path]##link:#quarkus-langchain4j-anthropic_quarkus-langchain4j-anthropic-chat-model-thinking-display[`+++quarkus.langchain4j.anthropic.chat-model.thinking.display+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.anthropic.chat-model.thinking.display+++[]
endif::add-copy-button-to-config-props[]
...
Valid values: `"summarized"` and `"omitted"`. On Claude Opus 4.7 the server default is `"omitted"` (thinking blocks are empty in the response). On earlier Opus/Sonnet models the default is `"summarized"`. Set to `"summarized"` explicitly on Opus 4.7{plus} if your product renders thinking text to users.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_ANTHROPIC_CHAT_MODEL_THINKING_DISPLAY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_ANTHROPIC_CHAT_MODEL_THINKING_DISPLAY+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a| [[quarkus-langchain4j-anthropic_quarkus-langchain4j-anthropic-model-name-chat-model-thinking-display]] [.property-path]##link:#quarkus-langchain4j-anthropic_quarkus-langchain4j-anthropic-model-name-chat-model-thinking-display[`+++quarkus.langchain4j.anthropic."model-name".chat-model.thinking.display+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.anthropic."model-name".chat-model.thinking.display+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_ANTHROPIC__MODEL_NAME__CHAT_MODEL_THINKING_DISPLAY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_ANTHROPIC__MODEL_NAME__CHAT_MODEL_THINKING_DISPLAY+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a| [[quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-calling-round-trips]] [.property-path]##link:#quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-calling-round-trips[`+++quarkus.langchain4j.ai-service.max-tool-calling-round-trips+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ai-service.max-tool-calling-round-trips+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_CALLING_ROUND_TRIPS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_CALLING_ROUND_TRIPS+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++10+++`

a| [[quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-executions]] [.property-path]##link:#quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-executions[[.line-through]#`+++quarkus.langchain4j.ai-service.max-tool-executions+++`#]##
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated since `1.11.0`: Use `max-tool-calling-round-trips()` instead._
...
h|[.extension-name]##Quarkus LangChain4j - Neo4j embedding store##
h|Type
h|Default
...
h|[.extension-name]##Quarkus LangChain4j - Pinecone embedding store##
h|Type
h|Default
