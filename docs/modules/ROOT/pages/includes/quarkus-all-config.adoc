...
h|[.extension-name]##Quarkus LangChain4j - hibernate##
h|Type
h|Default
...
[.description]
--
The name of the configured datasource to use for this store. If not set, the default datasource from the Agroal extension will be used, unless a persistence unit is provided.
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-table]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-table[`quarkus.langchain4j.hibernate-dynamic.table`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-dimension]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-dimension[`quarkus.langchain4j.hibernate-dynamic.dimension`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-create-index]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-create-index[`quarkus.langchain4j.hibernate-dynamic.create-index`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-index-options]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-index-options[`quarkus.langchain4j.hibernate-dynamic.index-options`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-index-type]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-index-type[`quarkus.langchain4j.hibernate-dynamic.index-type`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-create-table]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-create-table[`quarkus.langchain4j.hibernate-dynamic.create-table`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-drop-table-first]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-drop-table-first[`quarkus.langchain4j.hibernate-dynamic.drop-table-first`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-distance-function]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-dynamic-distance-function[`quarkus.langchain4j.hibernate-dynamic.distance-function`]##
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
The name of the entity of the configured Hibernate persistence unit to use for this store. If not set and the persistence unit has exactly one entity with `@Embedding`, that entity is used.
...
[.description]
--
The name of the configured Hibernate persistence unit to use for this store. If not set, the default persistence unit name from the Hibernate extension will be used.
...
a| [[quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-setup-vector-config]] [.property-path]##link:#quarkus-langchain4j-hibernate_quarkus-langchain4j-hibernate-setup-vector-config[`quarkus.langchain4j.hibernate.setup-vector-config`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.hibernate.setup-vector-config+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_HIBERNATE_SETUP_VECTOR_CONFIG+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_HIBERNATE_SETUP_VECTOR_CONFIG+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
