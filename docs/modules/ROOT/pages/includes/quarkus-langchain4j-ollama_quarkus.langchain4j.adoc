...
a| [[quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-chat-model-options-options]] [.property-path]##link:#quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-chat-model-options-options[`+++quarkus.langchain4j.ollama.chat-model.options."options"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ollama.chat-model.options."options"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Additional model options to pass to Ollama. For example, to enable thinking mode: `quarkus.langchain4j.ollama.chat-model.options.think=true`


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_OLLAMA_CHAT_MODEL_OPTIONS__OPTIONS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_OLLAMA_CHAT_MODEL_OPTIONS__OPTIONS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|`+++{}+++`
...
a| [[quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-embedding-model-options-options]] [.property-path]##link:#quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-embedding-model-options-options[`+++quarkus.langchain4j.ollama.embedding-model.options."options"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ollama.embedding-model.options."options"+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Additional model options to pass to Ollama. These are passed as-is to the Ollama API.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_OLLAMA_EMBEDDING_MODEL_OPTIONS__OPTIONS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_OLLAMA_EMBEDDING_MODEL_OPTIONS__OPTIONS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|`+++{}+++`
...
a| [[quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-model-name-chat-model-options-options]] [.property-path]##link:#quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-model-name-chat-model-options-options[`+++quarkus.langchain4j.ollama."model-name".chat-model.options."options"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ollama."model-name".chat-model.options."options"+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_OLLAMA__MODEL_NAME__CHAT_MODEL_OPTIONS__OPTIONS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_OLLAMA__MODEL_NAME__CHAT_MODEL_OPTIONS__OPTIONS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|`+++{}+++`
...
a| [[quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-model-name-embedding-model-options-options]] [.property-path]##link:#quarkus-langchain4j-ollama_quarkus-langchain4j-ollama-model-name-embedding-model-options-options[`+++quarkus.langchain4j.ollama."model-name".embedding-model.options."options"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ollama."model-name".embedding-model.options."options"+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_OLLAMA__MODEL_NAME__EMBEDDING_MODEL_OPTIONS__OPTIONS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_OLLAMA__MODEL_NAME__EMBEDDING_MODEL_OPTIONS__OPTIONS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|`+++{}+++`
