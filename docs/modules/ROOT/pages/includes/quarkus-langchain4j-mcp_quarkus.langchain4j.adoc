...
a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-protocol-version]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-protocol-version[`+++quarkus.langchain4j.mcp."client-name".protocol-version+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".protocol-version+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__PROTOCOL_VERSION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__PROTOCOL_VERSION+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-tool-list-changes]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-tool-list-changes[`+++quarkus.langchain4j.mcp."client-name".subscribe-to-tool-list-changes+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".subscribe-to-tool-list-changes+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_TOOL_LIST_CHANGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_TOOL_LIST_CHANGES+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-prompt-list-changes]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-prompt-list-changes[`+++quarkus.langchain4j.mcp."client-name".subscribe-to-prompt-list-changes+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".subscribe-to-prompt-list-changes+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_PROMPT_LIST_CHANGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_PROMPT_LIST_CHANGES+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-resource-list-changes]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subscribe-to-resource-list-changes[`+++quarkus.langchain4j.mcp."client-name".subscribe-to-resource-list-changes+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".subscribe-to-resource-list-changes+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_RESOURCE_LIST_CHANGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSCRIBE_TO_RESOURCE_LIST_CHANGES+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
