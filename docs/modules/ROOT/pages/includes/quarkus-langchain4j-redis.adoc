...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-redis_quarkus.langchain4j.redis.distance-metric]]`link:#quarkus-langchain4j-redis_quarkus.langchain4j.redis.distance-metric[quarkus.langchain4j.redis.distance-metric]`
