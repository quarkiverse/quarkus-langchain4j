...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-oidc-mcp-auth-provider_quarkus-enabled]] [.property-path]##link:#quarkus-langchain4j-oidc-mcp-auth-provider_quarkus-enabled[`+++quarkus.enabled+++`]##
