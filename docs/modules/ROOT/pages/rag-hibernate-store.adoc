...
The default entity type that is used for `hibernate-dynamic` configurations is `EmbeddingEntity`.
Replace the type when defining a custom entity via the `hibernate` configuration.
