...
// Generated from diagrams/rag-query-advanced-flow.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::rag-query-advanced-flow.svg[Advanced RAG architecture,align="center"]
