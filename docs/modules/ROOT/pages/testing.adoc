...
// Generated from diagrams/evaluation-flow.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::evaluation-flow.svg[Evaluation process,align="center"]
...
* `target/test-suite-report.md`: Aggregated test suite report
* `target/test-suite-report.json`: Aggregated test suite JSON report
