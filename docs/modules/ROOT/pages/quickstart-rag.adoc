...
// Generated from diagrams/quickstart-rag-ingestion.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::quickstart-rag-ingestion.svg[Ingestion phase,align="center"]
...
// Generated from diagrams/quickstart-rag-retrieval.mmd. See "Regenerating diagrams" in docs/README.adoc.
image::quickstart-rag-retrieval.svg[Retrieval phase]
