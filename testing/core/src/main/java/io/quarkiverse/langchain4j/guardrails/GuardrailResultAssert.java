...
public sealed abstract class GuardrailResultAssert<A extends GuardrailResultAssert<A, R, F>, R extends GuardrailResult<R>, F extends Failure>
    ...
    public A hasResult(Result result) {
        ...
        if (!Objects.equals(actual.getResult(), result)) {
            throw failureWithActualExpected(
                    actual.getResult(), result, "Expected result to be <%s> but was <%s>", result, actual.getResult());
        }
    ...
    public A hasSuccessfulText(String successfulText) {
        ...
        if (!Objects.equals(actual.successfulText(), successfulText)) {
            throw failureWithActualExpected(
                    actual.successfulText(), successfulText, "Expected successful text to be <%s> but was <%s>", successfulText,
    ...
    /**
     * Asserts that the actual {@link Result} contains the specified successful result.
     * This method verifies that the actual instance is in a successful state and that
     * the successful result matches the expected value. If the assertion fails, an error
     * is thrown detailing the mismatch.
     *
     * @param successfulResult the expected successful result to compare against the actual object's result
     * @return this assertion object for method chaining
     * @throws AssertionError if the actual object is not successful or if the successful result does not match the expected
     *         result
     */
    public A hasSuccessfulResult(Object successfulResult) {
        isSuccessful();

        if (!Objects.equals(actual.successfulResult(), successfulResult)) {
            throw failureWithActualExpected(
                    actual.successfulResult(), successfulResult, "Expected successful result to be <%s> but was <%s>",
                    successfulResult,
                    actual.successfulResult());
        }
    ...
    /**
     * Asserts that the actual {@link Result} contains the specified successful text and successful result.
     * This method verifies that the actual instance is in a successful state, that the successful text matches
     * the given value, and that the successful result matches the expected result. If the assertion fails, an
     * error is thrown detailing the mismatch.
     *
     * @param successfulText the expected text for the successful state
     * @param successfulResult the expected result for the successful state
     * @return this assertion object for method chaining
     * @throws AssertionError if the actual object is not successful, if the successful text does not match,
     *         or if the successful result does not match the expected result
     */
    public A hasSuccess(String successfulText, Object successfulResult) {
        hasSuccessfulText(successfulText);
        hasSuccessfulResult(successfulResult);

        return (A) this;
    }

    /**
     * Asserts that the actual {@code Result} represents a successful state.
    ...
    /**
     * Asserts that the actual {@code Result} contains failures.
    ...
    /**
     * Asserts that the actual {@code Result} contains exactly one failure with the specified message.
    ...
    /**
     * Asserts that the {@code Result} contains exactly one {@link GuardrailResult.Failure} and verifies
