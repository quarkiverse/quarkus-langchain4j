...
public interface SkillsConfiguration {
     ...
     * Each entry is either an absolute or relative path in the filesystem, or, if it's prepended with "classpath:", is considered a classpath resource.
     * A relative path is resolved against the current working directory at runtime.
     */
