...
/**
 * Quarkus Qdrant EmbeddingStore Implementation
 * <p>
 * Unlike the langChain4j QdrantEmbeddingStore which uses the Qdrant gRPC client,
 * this implementation uses the quarkus-qdrant REST client for native compatibility
 * and Quarkus-managed configuration.
 */
