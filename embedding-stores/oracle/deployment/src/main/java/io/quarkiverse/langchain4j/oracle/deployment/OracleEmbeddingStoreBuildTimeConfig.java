...
@ConfigMapping(prefix = "quarkus.langchain4j.oracle")
public interface OracleEmbeddingStoreBuildTimeConfig {
    ...
    @WithParentName
    @WithDefaults
    Map<String, OracleNamedStoreBuildTimeConfig> namedConfig();

    @ConfigGroup
    interface DefaultStoreBuildTimeConfig {

        /**
         * Whether the default (unnamed) Oracle embedding store should be enabled.
        ...
        /**
         * The name of the configured Oracle datasource to use for the default store.
