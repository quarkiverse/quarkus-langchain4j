...
public class WireMockUtil {
    ...
    public static final String URL_WATSONX_DEPLOYMENT_CHAT_API = "/ml/v1/deployments/{id}/text/generation?version=%s";
    public static final String URL_WATSONX_CHAT_STREAMING_API = "/ml/v1/text/generation_stream?version=%s";
    public static final String URL_WATSONX_DEPLOYMENT_CHAT_STREAMING_API = "/ml/v1/deployments/{id}/text/generation_stream?version=%s";
