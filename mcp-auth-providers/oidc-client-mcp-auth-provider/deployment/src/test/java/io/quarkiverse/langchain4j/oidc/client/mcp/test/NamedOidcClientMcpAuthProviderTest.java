...
class NamedOidcClientMcpAuthProviderTest {
    ...
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.mcp.client1.url", "http://localhost:8082/mcp")
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.mcp.client2.url", "http://localhost:8083/mcp")
