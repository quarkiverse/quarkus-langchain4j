...
class NamedOidcClientMcpAuthProviderTest {
    ...
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.mcp.client1.extra-params.oidc-client-name", "provider1")
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.mcp.client2.extra-params.oidc-client-name", "provider2")
