...
public class ToolnameValidationSameMethodNameToolBoxTest {

    @RegisterAiService(tools = { ChatToolOne.class })
    @ApplicationScoped
    public interface ToolBoxNameConflict {

        @SystemMessage("You are a helpful assistant.")
        @ToolBox(ChatToolTwo.class)
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(ToolBoxNameConflict.class, ChatToolOne.class,
                            ChatToolTwo.class, MyLanguageModel.class,
