...
public class MaxToolCallingRoundTripsStreamingTest {
    ...
    public interface StreamingAssistantWithCap3 {
    ...
    @Inject
    StreamingAssistantWithCap3 assistant;

    @Test
    @ActivateRequestContext
    public void testStreamingRoundTripLimitEnforced() {
