...
import io.quarkiverse.langchain4j.deployment.GuardrailObservabilityProcessor.TransformType;
...
class GuardrailObservabilityProcessorTest {
    ...
    void hasMetricsAnnotations(Class<?> clazz) {
        ...
        assertThat(methodInfo)
                .isNotNull()
                .extracting(GuardrailObservabilityProcessor::doesMethodHaveMetricsAnnotations)
                .isEqualTo(true);
    }
    ...
    void hasSpanAnnotation() {
        ...
        assertThat(methodInfo)
                .isNotNull()
                .extracting(GuardrailObservabilityProcessor::doesMethodHaveSpanAnnotation)
                .isEqualTo(true);
    }
    ...
    void isGuardrailValidateMethodWithParams(ClassInfoMapping classInfoMapping) {
        ...
        var hasGuardrailValidateMethodWithParams = allMethods.stream()
                .filter(GuardrailObservabilityProcessor::isGuardrailValidateMethodWithParams)
                .count() > 0;
    ...
    void shouldTransformMethod(ClassInfoMapping classInfoMapping) {
        ...
        var allMethodsThatShouldHaveMetricsTransformed = allMethods.stream()
                .filter(methodInfo -> GuardrailObservabilityProcessor.shouldTransformMethod(methodInfo, this.index,
