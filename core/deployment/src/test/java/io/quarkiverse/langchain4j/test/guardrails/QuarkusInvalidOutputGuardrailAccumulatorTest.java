...
public class QuarkusInvalidOutputGuardrailAccumulatorTest {
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .assertException(t -> {
                ...
                assertThat(t).hasMessageContaining(
                        "io.quarkiverse.langchain4j.test.guardrails.QuarkusInvalidOutputGuardrailAccumulatorTest$MyAiService.hi");
            });
