                ...
                try {
                    ...
                    if (info.toolHallucinationStrategyClassName() != null) {
                        Object toolHallucinationStrategy = creationalContext.getInjectedReference(
                                Thread.currentThread().getContextClassLoader().loadClass(info.toolHallucinationStrategyClassName()));
                        if (toolHallucinationStrategy == null) {
                            throw new IllegalStateException("Unknown tool hallucination strategy: " + info.toolHallucinationStrategyClassName());
                        }
