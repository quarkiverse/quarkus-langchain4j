package io.quarkiverse.langchain4j.opensearch.test;
...
public class Langchain4jOpensearchTest {
    ...
    public void cleanup() throws SQLException {
        openSearchEmbeddingStore.deleteAll();
    }

    @Test
    void should_add_embedding() {
        assertThat(embeddingStore).isSameAs(openSearchEmbeddingStore);
