...
class McpResourcesStreamableHttpTest extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesStreamableHttpTest.class);
