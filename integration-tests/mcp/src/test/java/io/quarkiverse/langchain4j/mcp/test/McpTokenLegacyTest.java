...
class McpTokenLegacyTest {

    private static final Logger log = LoggerFactory.getLogger(McpTokenLegacyTest.class);
    ...
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.langchain4j.mcp.client2.protocol-version", "2025-11-25")
            ...
            .overrideConfigKey("quarkus.langchain4j.mcp.client4.protocol-version", "2025-11-25")
