...
class McpResourcesWebSocketLegacyTest extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesWebSocketLegacyTest.class);
