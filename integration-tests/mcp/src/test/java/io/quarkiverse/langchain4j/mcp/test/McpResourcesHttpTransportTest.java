...
class McpResourcesHttpTransportTest extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesHttpTransportTest.class);
