...
class McpStaticHeadersStreamableHttpLegacyTest extends McpStaticHeadersTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpStaticHeadersStreamableHttpLegacyTest.class);
