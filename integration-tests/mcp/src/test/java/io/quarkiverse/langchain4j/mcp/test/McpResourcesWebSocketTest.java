...
class McpResourcesWebSocketTest extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesWebSocketTest.class);
    ...
    static void setup() throws Exception {
        ...
        process = startServerHttp("resources_mcp_server.java", 8182);
    }
