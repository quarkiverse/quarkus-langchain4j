...
class McpToolsStreamableHttpLegacyTest extends McpToolsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolsStreamableHttpLegacyTest.class);
