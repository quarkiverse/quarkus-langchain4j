...
class McpDynamicHeadersStreamableHttpTransportTest extends McpDynamicHeadersTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpDynamicHeadersStreamableHttpTransportTest.class);
    private static Process process;

    @RegisterExtension
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(McpServerHelper.class, TestMcpHeadersSupplier.class))
