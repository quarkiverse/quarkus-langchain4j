...
class McpPromptsStreamableHttpTest extends McpPromptsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpPromptsStreamableHttpTest.class);
    ...
    static void setup() throws Exception {
        ...
        process = startServerHttp("prompts_mcp_server.java", 8182);
    }
