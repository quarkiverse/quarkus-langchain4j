...
class McpDynamicHeadersStreamableHttpLegacyTest extends McpDynamicHeadersTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpDynamicHeadersStreamableHttpLegacyTest.class);
