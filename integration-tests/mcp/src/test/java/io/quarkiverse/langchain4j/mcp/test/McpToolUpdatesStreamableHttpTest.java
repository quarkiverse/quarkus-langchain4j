...
class McpToolUpdatesStreamableHttpTest {

    private static final Logger log = LoggerFactory.getLogger(McpToolUpdatesStreamableHttpTest.class);
    ...
    static void setup() throws Exception {
        ...
        process = startServerHttp("tool_list_updates_mcp_server.java", 8182);
    }
