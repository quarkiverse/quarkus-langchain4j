...
class McpResourcesAsToolsWebSocketLegacyTest extends McpResourcesAsToolsTestBase {

    @RegisterExtension
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(McpServerHelper.class))
            .overrideConfigKey("quarkus.langchain4j.mcp.alice.transport-type", "websocket")
            .overrideConfigKey("quarkus.langchain4j.mcp.alice.protocol-version", "2025-11-25")
            .overrideConfigKey("quarkus.langchain4j.mcp.alice.url",
                    "ws://localhost:8180/mcp/ws")
            ...
            .overrideConfigKey("quarkus.langchain4j.mcp.bob.transport-type", "websocket")
            .overrideConfigKey("quarkus.langchain4j.mcp.bob.protocol-version", "2025-11-25")
            .overrideConfigKey("quarkus.langchain4j.mcp.bob.url",
                    "ws://localhost:8181/mcp/ws")
