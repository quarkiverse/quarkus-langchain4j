...
class McpPromptsStreamableHttpTransportTest extends McpPromptsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpPromptsStreamableHttpTransportTest.class);
