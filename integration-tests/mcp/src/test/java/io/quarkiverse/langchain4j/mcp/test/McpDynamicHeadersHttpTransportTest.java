...
class McpDynamicHeadersHttpTransportTest extends McpDynamicHeadersTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpDynamicHeadersHttpTransportTest.class);
