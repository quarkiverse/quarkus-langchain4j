...
class McpPromptsStreamableHttpLegacyTest extends McpPromptsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpPromptsStreamableHttpLegacyTest.class);
