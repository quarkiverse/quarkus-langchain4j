...
class McpResourcesStreamableHttpLegacyTest extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesStreamableHttpLegacyTest.class);
