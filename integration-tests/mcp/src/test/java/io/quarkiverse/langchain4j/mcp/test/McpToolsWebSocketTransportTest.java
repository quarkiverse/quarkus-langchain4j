...
class McpToolsWebSocketTransportTest extends McpToolsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolsWebSocketTransportTest.class);
