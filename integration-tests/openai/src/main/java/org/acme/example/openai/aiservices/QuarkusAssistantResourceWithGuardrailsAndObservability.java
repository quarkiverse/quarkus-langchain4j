...
@Path("quarkus-assistant-with-guardrails-observability")
public class QuarkusAssistantResourceWithGuardrailsAndObservability {
    private final Assistant assistant;

    public QuarkusAssistantResourceWithGuardrailsAndObservability(Assistant assistant) {
