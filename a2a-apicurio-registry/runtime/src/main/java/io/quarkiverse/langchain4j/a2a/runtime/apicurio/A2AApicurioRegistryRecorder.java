...
public class A2AApicurioRegistryRecorder {
    ...
    public Function<SyntheticCreationalContext<ApicurioAgentsRegistry>, ApicurioAgentsRegistry> agentsRegistryFunction(
        ...
        return new Function<>() {
            ...
            public ApicurioAgentsRegistry apply(SyntheticCreationalContext<ApicurioAgentsRegistry> context) {
                ...
                RegistryClient registryClient = createRegistryClient(config, vertx.get());
    ...
    private static RegistryClient createRegistryClient(A2AApicurioRegistryRuntimeConfig config, Vertx vertx) {
        ...
        RegistryClientOptions options = RegistryClientOptions.create(url, vertx);
