...
public class A2AServerUrlSupplierTest {
    ...
    void test() {
        ...
        // with the dynamically supplied URL
    ...
    public interface CreativeWriter {
        ...
        @A2AClientAgent(description = "Generate a story based on the given topic", outputKey = "story")
        String generateStory(@V("topic") String topic);

        @A2AServerUrlSupplier
        static String a2aServerUrl() {
