...
import com.ibm.watsonx.ai.textprocessing.schema.create.CreateSchemaRequest;
...
@Path("")
public interface CreateSchemaRestApi {

    @POST
    @Path("/ml/v1/text/schemas/create")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CreateSchemaResponse startRequest(
    ...
    @GET
    @Path("/ml/v1/text/schemas/create/{request_id}")
    @Produces(MediaType.APPLICATION_JSON)
    CreateSchemaResponse fetchRequestDetails(
