...
public class OllamaClient {
    ...
    public OllamaClient(String baseUrl, Duration timeout, boolean logRequests, boolean logResponses, boolean logCurl,
            String configName, String tlsConfigurationName) {
        try {
            // TODO: cache?
            ...
            if (logRequests || logResponses || logCurl) {
                ...
                builder.clientLogger(new OllamaRestApi.OllamaLogger(logRequests, logResponses, logCurl));
            }
