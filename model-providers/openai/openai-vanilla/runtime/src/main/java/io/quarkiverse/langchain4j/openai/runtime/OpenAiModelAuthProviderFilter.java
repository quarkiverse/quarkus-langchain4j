...
public class OpenAiModelAuthProviderFilter implements ResteasyReactiveClientRequestFilter {

    private final ModelAuthProvider authorizer;

    public OpenAiModelAuthProviderFilter(String configName) {
        this.authorizer = ModelAuthProvider.resolve(configName)
                .orElseThrow(() -> new IllegalStateException(
                        "ModelAuthProvider not available for config '" + configName + "'"));
    }
