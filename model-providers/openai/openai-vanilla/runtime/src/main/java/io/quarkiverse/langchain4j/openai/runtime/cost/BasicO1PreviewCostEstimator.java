...
public class BasicO1PreviewCostEstimator implements CostEstimator {
    ...
    private static final BigDecimal INPUT_COST = BigDecimal.valueOf(15).divide(BigDecimal.valueOf(1_000_000));
    private static final BigDecimal OUTPUT_COST = BigDecimal.valueOf(60).divide(BigDecimal.valueOf(1_000_000));

    @Override
    public boolean supports(SupportsContext context) {
        return "o1-preview".equals(context.model());
    }
