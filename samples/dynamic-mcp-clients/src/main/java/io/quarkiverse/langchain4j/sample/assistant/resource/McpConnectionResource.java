...
public class McpConnectionResource {
    ...
    public static class Templates {
        ...
        public static native TemplateInstance authRequired(String name, String transportType, String command, String url);
    }
    ...
    public TemplateInstance addConnection(@FormParam("name") String name,
        ...
        try {
            ...
            if (e.getMessage().contains("401")) {
                return Templates.authRequired(name, transportType, command, url);
            } else {
